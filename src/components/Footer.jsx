...
<script>
  function ml_webform_success_27522838() {
    var $ = ml_jQuery || jQuery;
    $('.ml-subscribe-form-27522838 .row-success').show();
    $('.ml-subscribe-form-27522838 .row-form').hide();
  }
</script>
<script src="https://groot.mailerlite.com/js/w/webforms.min.js?v176e10baa5e7ed80d35ae235be3d5024" type="text/javascript"></script>
<script>
  fetch("https://assets.mailerlite.com/jsonp/1613419/forms/157952342155593362/takel")
</script>
` } />
  );
}
